...
public class RedisUtil {
    ...
    public void setRedisTemplate(int database) {
        JedisConnectionFactory jedisConnectionFactory = (JedisConnectionFactory) this.template.getConnectionFactory();
        jedisConnectionFactory.setDatabase(database);
        this.template.setConnectionFactory(jedisConnectionFactory);
    }
     ...
     * @return
     */
    public Object hget(String key, Collection<Object> collection){
//        return template.opsForHash().multiGet(key, collection);
        return template.boundHashOps(key).multiGet(collection);
    }
    ...
    public double hincr(String key, String hashKey, double by) {
        return template.opsForHash().increment(key, hashKey, by);
    }
